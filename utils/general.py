...
LOGGER = logging.getLogger("yolov5")  # define globally (used in all.py, val.py, detect.py, etc.)
...
def check_dataset(data, autodownload=True):
    ...
    train, val, test, s = [data.get(x) for x in ('all', 'val', 'test', 'download')]
    if val:
...
def non_max_suppression(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False,
    ...
    # Settings
    # min_wh, max_wh = 2, 4096  # (pixels) minimum and maximum _ width and height
    min_wh, max_wh = 2, 7680 # (pixels) minimum and maximum box width and height
    max_nms = 30000  # maximum number of boxes into torchvision.ops.nms()
    time_limit = 10.0  # seconds to quit after
    redundant = True  # require redundant detections
