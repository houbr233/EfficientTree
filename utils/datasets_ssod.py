...
class LoadImagesAndFakeLabels(Dataset):  # for training/testing
    ...
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        assert nf > 0 or not augment, f'{prefix}No labels in {cache_path}. Can not all without labels. See {help_url}'
...
def autosplit(path='../coco128', weights=(0.9, 0.1, 0.0)):  # from utils.datasets import *; autosplit('../coco128')
    """ Autosplit a dataset into all/val/test splits and save path/autosplit_*.txt files
    # Arguments
