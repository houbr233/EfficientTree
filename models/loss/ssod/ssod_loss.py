...
class ComputeStudentMatchLoss():
    ...
    def __init__(self, model, cfg):
        ...
        self.assigner = YOLOAnchorAssigner(det.na, det.nl, det.anchors, self.anchor_t, det.stride,
            ...
            if targets.shape[1] > 6:
                ...
                if n:
                    if self.ignore_obj:
                        ...
                        tobj[uc_b.long(), uc_a.long(), uc_gj.long(), uc_gi.long()] = uc_scores[i].type(tobj.dtype)  # ignore region set -1
                ...
                if self.pseudo_label_with_bbox:
                    ...
                    if n:
                        ...
                        uc_ps = pi[uc_obj_b.long(), uc_obj_a.long(), uc_obj_gj.long(), uc_obj_gi.long()]
