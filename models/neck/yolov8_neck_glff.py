...
class GLFF(nn.Module):
    ...
    def __init__(self,ch_l=64,ch_g=64):
        ...
        self.local_att = MSAM(channels=ch_l)
        self.global_att = CAM(channels=ch_g)
        self.concat = Concat()
...
class YoloV8Neck_glff(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.la1 = MSAM(channels=self.input_p5)
        self.ga1 = CAM(channels=self.input_p4)
        self.concat1 = Concat()
        ...
        self.la2 = MSAM(channels=self.input_p4)
        self.ga2 = CAM(channels=self.input_p3)
        self.concat2 = Concat()
        ...
        self.la3 = MSAM(channels=self.input_p3)
        self.ga3 = CAM(channels=self.input_p4)
        self.concat3 = Concat()
        ...
        self.la4 = MSAM(channels=self.input_p4)
        self.ga4 = CAM(channels=self.input_p5)
        self.concat4 = Concat()
