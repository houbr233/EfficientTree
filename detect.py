...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/sup/监督对比/yolov5s/all_tree_overlap_0_patch_640/weights/best.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=ROOT / 'data/all/tree_overlap_0_patch_640/images/test', help='file/dir/URL/glob, 0 for webcam')
    ...
    # opt = parser.parse_args(['--save-txt'])
