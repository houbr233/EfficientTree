...
class Bottleneck(nn.Module):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, e=0.5, act=True):  # ch_in, ch_out, shortcut, groups, expansion, act
        ...
        self.cv1 = Conv(c1, c_, 3, 1, act=act)
...
class C2f(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5, act=True):  # ch_in, ch_out, number, shortcut, groups, expansion
        ...
        self.m = nn.ModuleList(Bottleneck(self.c, self.c, shortcut, g, e=1.0, act=act) for _ in range(n))
...
class YoloV8BackBone(nn.Module):
    def __init__(self, cfg):
        ...
        self.stage1 = Conv(3, self.channels_out['stage1'], 3, 2, 2, 1, CONV_ACT)
        ...
        self.stage2_2 = C2f(self.channels_out['stage2_1'], self.channels_out['stage2_2'], self.get_depth(3), True, 1,
                            0.5, C_ACT)
        self.stage3_1 = Conv(self.channels_out['stage2_2'], self.channels_out['stage3_1'], 3, 2, None, 1, CONV_ACT)
        self.stage3_2 = C2f(self.channels_out['stage3_1'], self.channels_out['stage3_2'], self.get_depth(6), True, 1,
                            0.5, C_ACT)
        self.stage4_1 = Conv(self.channels_out['stage3_2'], self.channels_out['stage4_1'], 3, 2, None, 1, CONV_ACT)
        self.stage4_2 = C2f(self.channels_out['stage4_1'], self.channels_out['stage4_2'], self.get_depth(6), True, 1,
                            0.5, C_ACT)
        self.stage5_1 = Conv(self.channels_out['stage4_2'], self.channels_out['stage5'], 3, 2, None, 1, CONV_ACT)
        self.stage5_2 = C2f(self.channels_out['stage5'], self.channels_out['csp1'], self.get_depth(3), True, 1, 0.5,
                            C_ACT)
