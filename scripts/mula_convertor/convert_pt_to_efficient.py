...
def convert_yolov5_to_efficient(pt_path='', cfg_path='', save_path='', map_path=''):
        ...
        model = Model(cfg)
        print('load weights from u-yolo...')
...
# def convert_efficient_to_yolov5(efficient_path='',  yolov5_path='', save_path='', map_path=''):
#         with open(map_path, 'r') as f:
#             content = f.readlines()
#         content = [i.strip().split(' ') for i in content]
#         match_dict = {}
...
if __name__ == '__main__':
    # convert_yolov5_to_efficient('yolov8s.pt', str(root1) + '/configs/sup/public/yolov8s_coco.yaml',
    #                              'efficient-yolov8s.pt', map_path='map_v8.txt')
    convert_efficient_to_yolov5('efficient-yolov5s.pt', yolov5_path='yolov5s.pt', save_path='test.pt',map_path='map_v5_et.txt')
    #convert_efficient_to_yolov5("combined_model.pt", yolov5_path='yolov5s.pt', save_path='test.pt',map_path='map_v5_et.txt')
